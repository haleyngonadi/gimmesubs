...
window.addEventListener('load', function (e) {
    ...
    // var whatsplaying = document.getElementById('passage-audio').offsetWidth;


    // var elements = document.getElementsByClassName("speaking");
    // for (var i = 0; i < elements.length; i++) {
    //     var num = parseFloat(whatsplaying);
    //     var val = num - (num * .25);
    //     elements[i].style.width= val+"px";

    // }
    console.log(document.getElementsByClassName('speaking'));
